...
export const DashboardSection = () => {
  ...
  // Form state
  const [role, setRole] = useState(user?.role_pref || 'swe_intern');
  ...
  const track: Track = ROLE_TO_TRACK[role] || 'swe_intern';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Start a new interview session or continue where you left off</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 bg-white rounded-xl border border-gray-200 overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-100">
            <h2 className="text-lg font-semibold text-gray-900">Start New Interview</h2>
            <p className="text-sm text-gray-500 mt-0.5">Configure your interview settings</p>
          </div>
          ...
          <div className="p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-gray-900 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                >
              ...
              {/* Company Style */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Company Style</label>
                <select
                  value={companyStyle}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Behavioral Questions</label>
                <select
            ...
            <div className="mt-5">
              <label className="block text-sm font-medium text-gray-700 mb-3">Choose Your Interviewer</label>
                  ...
                  >
                    ...
                    <div className="mt-2">
                      <div className={`font-medium text-sm ${
                        selectedInterviewer === person.id ? 'text-blue-700' : 'text-gray-900'
                      }`}>
                        {person.name}
                      </div>
            ...
            <button
              ...
              disabled={isStarting}
              className="mt-6 w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white rounded-lg font-medium transition-colors"
            >
              {isStarting ? (
                <>
                  {Icons.spinner}
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-100">
            ...
            <p className="text-sm text-gray-500 mt-0.5">Your interview performance</p>
          </div>
          ...
          <div className="p-4">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-2 mb-1">
                  <div className="w-7 h-7 bg-blue-100 rounded-md flex items-center justify-center text-blue-600">
                    {Icons.chart}
                  </div>
                </div>
              ...
              <div className="p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-2 mb-1">
                  <div className="w-7 h-7 bg-orange-100 rounded-md flex items-center justify-center text-orange-600">
                    {Icons.fire}
                  </div>
                </div>
                <div className="text-xl font-bold text-gray-900">{stats.dayStreak}</div>
              ...
              <div className="p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-2 mb-1">
                  <div className="w-7 h-7 bg-purple-100 rounded-md flex items-center justify-center text-purple-600">
                    {Icons.clock}
                  </div>
                </div>
                <div className="text-xl font-bold text-gray-900">{stats.lastSession || '-'}</div>
              ...
              <div className="p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-2 mb-1">
                  <div className="w-7 h-7 bg-green-100 rounded-md flex items-center justify-center text-green-600">
                    {Icons.trophy}
                  </div>
                </div>
            ...
            <div className="mt-4 p-3 bg-gray-50 rounded-lg space-y-2">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-semibold text-amber-600">{inProgressSessions}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Resume or view results</p>
          </div>
        ...
        <div className="divide-y divide-gray-100">
          {isLoading ? (
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-500 text-sm mt-1">Start your first interview above</p>
            </div>
          ) : (
